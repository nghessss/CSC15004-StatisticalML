...
IMAGENET1K_CLASS_PATH = './video_feature_utils/IN1K_label_map.txt'
IMAGENET21K_CLASS_PATH = './video_feature_utils/IN21K_label_map.txt'
...
def build_cfg_path(feature_type: str) -> os.PathLike:
    ...
    '''
    path_base = Path('./video_feature_configs')
